...
npx snarkjs zkey export solidityverifier keys/Verifier.zkey contracts/generated/Verifier.sol
sed -i -e 's/pragma solidity \^0.6.11/pragma solidity 0.8.18/g' contracts/generated/Verifier.sol
mkdir -p static
